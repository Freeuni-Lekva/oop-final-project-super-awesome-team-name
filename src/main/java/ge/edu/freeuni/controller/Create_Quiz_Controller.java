...
public class Create_Quiz_Controller {
    ...
    @PostMapping
    public String createQuiz(@RequestParam Map<String, String> requestParams, HttpSession session) throws Exception {
        ...
        for (int i = 1; i <= NQuestions; i++) {
            ...
            switch (type) {
                ...
                case "Multi-Answer": {
                    ...
                    boolean orderMatter = "yes".equalsIgnoreCase(requestParams.get("orderMatters_" + i));
                ...
                default:
                    throw new IllegalArgumentException("Unrecognized Quiz Type");
            }
        }
        ...
        return "redirect:/Created_Quiz_Result.jsp";
    }
}
